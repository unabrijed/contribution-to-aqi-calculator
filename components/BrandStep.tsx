    ...
    <div>
      <div className="mb-6">
        ...
        <p className="text-ink-400 text-sm">
          Pick at least one brand per category. Where you usually use it affects exposure (indoors ≈
          3.5× impact on others vs outdoors).
        </p>
      </div>
        ...
        <div className="flex flex-wrap items-center gap-2">
          <div className="flex rounded-full border border-[var(--border)] bg-[var(--surface-2)] p-0.5">
            <button
              ...
              className={[
                "rounded-full px-3 py-1.5 text-2xs font-mono transition-all",
      ...
      <div className="mb-6 flex flex-wrap items-center gap-2 rounded-xl border border-[var(--border)] bg-[var(--surface-2)] px-3 py-2.5">
        <span className="text-2xs text-ink-500">
          <span className="font-medium text-ink-300">{activeCat.label}</span>
          {" — usual for this category:"}
        </span>
        <div className="flex rounded-full border border-[var(--border)] bg-[var(--surface-1)] p-0.5">
          <button
            type="button"
            onClick={() => setIndoorForCategory(activeTab, false)}
            className={[
              "rounded-full px-2.5 py-1 text-2xs font-mono transition-all",
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <button
          type="button"
          onClick={onBack}
          className="text-sm text-ink-500 hover:text-ink-300 transition-colors self-start"
        >
          ← back
        </button>
        <div className="flex flex-col items-stretch gap-2 sm:items-end">
          ...
          {primaryDisabled && (
            <span className="text-2xs text-ink-600 text-right">
          ...
          <button
            ...
            className="flex items-center justify-center gap-2 px-6 py-3 rounded-full bg-ember-500 text-white font-display font-medium text-sm disabled:opacity-30 disabled:cursor-not-allowed hover:bg-ember-600 active:scale-[0.98] transition-all"
          >
            {primaryLabel}
          </button>
        </div>
